...
.ButtonAdd {display: inline-block; text-align: right !important; margin: 10px 0px !important; padding: 5px 0px !important;}
.ButtonAdd:before{
  content:url(../public/images/icons/addThumb.png);
  margin-right: 5px;
  top: 5px;
  position: relative;
}
.ButtonDel {display: inline-block; text-align: right !important; margin: 10px 0px !important; padding: 5px 0px !important;}
.ButtonDel:before{
  content:url(../public/images/icons/deleteThumb.png);
  margin-right: 5px;
  top: 5px;
  position: relative;
}
