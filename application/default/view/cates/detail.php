...
<h3><span><?=$this->cates->name?></span></h3>
<?php foreach ($this->items as $n) : ?>
 <section class="content-item" >
    <div class="content-detail">
        ...
        <h6><a href="javascript:void(0)" data-item-alias="<?=$n->alias?>" class="item-url" title="<?=$n->title?>">Read more ... </a></h6>
    </div>
